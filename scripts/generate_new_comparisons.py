...
def generate(root: Path) -> int:
    ...
    for fname, spec in NEW_COMPARISONS.items():
        ...
        rows = (f'<tr><th>Best for</th>{best_cells}</tr>'
                ...
                f'<tr><th>AIToolsEssentials editorial score</th>{score_cells}</tr>')
...
<link rel="stylesheet" href="../css/share.css"><!-- AIT SEO START -->
  ...
  <meta name="twitter:title" content="{_e(title)} — AIToolsEssentials">
  <meta name="twitter:description" content="{_e(spec['subhead'])}">
  <script type="application/ld+json">{{"@context": "https://schema.org", "@type": "Article", "name": "{_e(title)} — AIToolsEssentials", "description": "{_e(spec['subhead'])}", "url": "https://aitoolsessentials.com/comparisons/{fname}", "isPartOf": {{"@type": "WebSite", "name": "AIToolsEssentials", "url": "https://aitoolsessentials.com/"}}, "publisher": {{"@type": "Organization", "name": "AIToolsEssentials", "url": "https://aitoolsessentials.com/"}}, "headline": "{_e(title)} — AIToolsEssentials", "author": {{"@type": "Organization", "name": "AIToolsEssentials"}}}}</script>
  <!-- AIT SEO END -->
