...
HEADER = '<header class="global-nav"><a class="brand" href="/index.html"><span class="brand-glyph">✦</span><span>AIToolsEssentials</span></a><nav class="nav-links"><a href="/tools/index.html">Tools</a><a href="/stack-builder.html">Stack builder</a><a href="/tool-finder.html">Tool finder</a><a href="/fit-interview/">Fit interview</a><a href="/confidence-check/">Confidence check</a><a href="/free-ai-tools.html">Free AI tools</a><a href="/alternatives/">Alternatives</a><a href="/comparisons/best-ai-tools.html">Best AI tools</a><a href="/articles/index.html">Guides</a><a href="/deals/">Deals</a></nav><a class="nav-cta" href="/pricing/">Premium</a></header>'
...
def generate_launch_kit(root: Path) -> None:
    posts = {
        ...
        "Pricing Watch — X post": "AI tools change prices quietly. We built a public tracker: every price tied to its official source with a checked date, changes logged as they happen. The current directory, zero guesses. https://aitoolsessentials.com/pricing-watch/",
        "Pricing Watch — LinkedIn post": "Most teams discover AI price increases at renewal. AIToolsEssentials now publishes verified pricing snapshots across the current directory, each traced to the vendor's official page with a checked date, plus a public change log when prices move. Free: https://aitoolsessentials.com/pricing-watch/",
        ...
        "Zero-traffic recovery — LinkedIn post": "We had a zero-visit day, so I turned the site into more of a search and decision utility: property-manager AI tools, podcast show tools, ChatGPT Free vs paid, Perplexity vs Google, cancel-anytime terms, offline AI, and deletion/data-retention guides. The useful starting point is the workflow library: https://aitoolsessentials.com/workflows/",
        "Property managers — Reddit post": "I made a fair-housing-aware AI tools guide for small landlords/property managers: listing copy, rent follow-up, maintenance notes, and why applicant SSNs/screening reports should not go into consumer chat. Feedback welcome: https://aitoolsessentials.com/articles/best-ai-tools-for-property-managers.html",
        "ChatGPT Free vs Plus — X post": "Before upgrading ChatGPT, track one thing: how often Free limits interrupt real work. I wrote a short official-source guide without guessing at unofficial prices: https://aitoolsessentials.com/articles/chatgpt-free-vs-plus.html",
        "Offline AI — X post": "Most AI tools are cloud-first. If you actually need offline AI, start with the workflow and hardware constraints, not hype. Short guide + local AI planner: https://aitoolsessentials.com/articles/do-ai-tools-work-offline.html",
        "Perplexity vs Google — Reddit post": "Perplexity is useful for a cited starting set. Google is still where you open the source, check freshness, and find navigational pages. I wrote the practical split here: https://aitoolsessentials.com/articles/perplexity-vs-google.html",
    }
...
def generate_feeds(root: Path, tools: list[dict[str, Any]], today: str) -> None:
    items = [
        ...
        ("AI Workflow Guides", "/workflows/", "Long-tail workflow guides for property manager operations, rental listing copy, podcast editing, nonprofit grant writing, consultant admin, knowledge bases, and more."),
