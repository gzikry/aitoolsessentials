...
def generate_feeds(root: Path, tools: list[dict[str, Any]], today: str) -> None:
    items = [
        ...
        ("AI Workflow Guides", "/workflows/", "Long-tail workflow guides for nonprofit grant writing, classroom lesson planning, medical practice admin, podcast editing, YouTube production, sales call follow-up, local AI, agents, marketing, research, and app prototyping."),
