...
<p>Issue 1 is live on the site: <a href="/newsletter/{issue_slug}.html">{issue_title}</a>. Paid <a href="/premium/">Premium</a> is a separate Whop membership. FormSubmit is only for tool submissions and intake — not this list.</p>
</div></section>
