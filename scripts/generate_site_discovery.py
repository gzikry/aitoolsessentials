...
def generate_human_sitemap(root: Path, tools: list[dict[str, Any]]) -> None:
    groups = [
        ...
        ("Trust", [("Changelog", "/changelog/"), ("Change Radar", "/change-radar/"), ("Community reports", "/community/test-report.html"), ("Get reviewed", "/get-reviewed/"), ("Affiliate disclosure", "/legal/affiliate-disclosure.html")]),
