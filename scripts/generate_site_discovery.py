...
def generate_human_sitemap(root: Path, tools: list[dict[str, Any]]) -> None:
    groups = [
        ...
        ("Decide", [("Stack Builder", "/stack-builder.html"), ("Cost Calculator", "/cost-calculator.html"), ("Free Stack Audit", "/stack-audit.html"), ("Automation Billing Decoder", "/automation-cost-decoder/"), ("Compare Shortlist", "/compare-shortlist.html"), ("Alternatives", "/alternatives/"), ("Pricing Watch", "/pricing-watch/"), ("Keep/Cut Weekly", "/newsletter/"), ("Paid Premium library", "/premium/library/")]),
...
def generate_start_here(root: Path) -> None:
    steps = [
        ...
        ("I want the $12/month membership", "Premium is live: 7-day free trial, then $12/month. Code LAUNCH50 for 50% off the first paid month.", "/premium/", "See Paid Premium"),
