...
def generate_human_sitemap(root: Path, tools: list[dict[str, Any]]) -> None:
    groups = [
        ...
        ("Trust", [("Changelog", "/changelog/"), ("Change Radar", "/change-radar/"), ("How-to library", "/how-to/"), ("Community reports", "/community/test-report.html"), ("Get reviewed", "/get-reviewed/"), ("Affiliate disclosure", "/legal/affiliate-disclosure.html")]),
...
def generate_status(root: Path, tools: list[dict[str, Any]], today: str) -> None:
    ...
    data = {
        ...
        "core_utilities": ["/stack-builder.html", "/tool-finder.html", "/fit-interview/", "/confidence-check/", "/change-radar/", "/cost-calculator.html", "/compare-shortlist.html"],
