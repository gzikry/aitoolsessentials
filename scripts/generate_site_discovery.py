...
def generate_status(root: Path, tools: list[dict[str, Any]], today: str) -> None:
    ...
    data = {
        ...
        "core_utilities": ["/stack-builder.html", "/tool-finder.html", "/fit-interview/", "/confidence-check/", "/change-radar/", "/how-to/", "/hardware/", "/cost-calculator.html", "/compare-shortlist.html"],
