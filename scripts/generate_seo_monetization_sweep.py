...
def postprocess(root: Path, tools: list[dict[str, Any]] | None = None, today: str | None = None) -> dict[str, int]:
    ...
    module = (
        ...
        # rel="sponsored nofollow" is REQUIRED here: these are commission-bearing links.
        # They previously carried rel="external nofollow noopener", which both misdeclared
        # paid placement to Google and (because the validator treated "external" as an
        # editorial-citation escape hatch) passed the site's own guard unnoticed.
