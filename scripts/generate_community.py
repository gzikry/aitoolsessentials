...
<header class="global-nav"><a class="brand" href="index.html"><span class="brand-glyph">✦</span><span>AIToolsEssentials</span></a><nav class="nav-links"><a href="tools/index.html">Tools</a><a href="comparisons/best-ai-tools.html">Best AI tools</a><a href="categories/index.html">Categories</a><a href="articles/index.html">Guides</a><a href="benchmarks/">Benchmarks</a></nav><a class="nav-cta" href="submit-tool.html">Submit evidence</a></header><main>
...
<section class="directory-section scene scene-light" id="community-report-queue"><div class="section-title"><p class="kicker light">Evidence queue</p><h2>Verified community results will publish here</h2><p>Community test reports are checked against our testing protocol before publication. Published reports identify the reporter's role, tool version, task, and date; vague endorsements do not clear verification.</p></div><div class="content-hub-grid"><article class="content-hub-card"><h3>Submit a reproducible result</h3><p>Include the tool and plan, a real task, time spent, output quality, what failed, and what you compared it with.</p><p><a class="button button-blue small" href="community/test-report.html">Report test results</a></p></article><article class="content-hub-card"><h3>Submit official product evidence</h3><p>Vendors can send current pricing, documentation, privacy, and rights sources for editorial consideration. Payment never changes rankings.</p><p><a class="button button-blue small" href="submit-tool.html">Submit a tool</a></p></article></div></section></main>
