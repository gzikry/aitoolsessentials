# HARO / Connectively Pitch Templates

## Template 1 — AI Tool Pricing Changes (reactive)

Subject: Source on AI tool pricing changes for [Publication Name]
...
## Template 2 — Overlapping Subscriptions / Cost Optimization

Subject: Expert source: how teams cut AI tool overlap
...
I can offer:
- Data on the most common overlaps (coding × 2, meeting notes × 2, assistants × 2)
- The 45-minute test protocol: run one real task through each tool, score output quality, keep the winner
- Pricing snapshots from official vendor pages with verified dates
...
## Template 3 — AI Tool Directory / Comparison (general)

Subject: Source for AI tool comparisons and pricing verification
...
- **Overlap**: Most buyers don't need more tools — they need to cut overlapping subscriptions. Our keep/cut framework helps them decide.
- **Editorial independence**: Affiliate status never changes our rankings.
...
## Keywords to track on Connectively

Set alerts for:
- "AI tool pricing" / "AI subscription"
- "SaaS costs" / "software spending"
- "overlapping tools" / "tool consolidation"
- "AI for business" / "AI productivity"
- "tech spending" / "software budget"
- "ChatGPT" OR "Claude" OR "Cursor" AND "pricing"
- "AI agents" AND "cost"
...
- Personal Finance (subscription costs)
- Productivity
- Software / SaaS
