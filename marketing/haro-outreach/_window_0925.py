...
Same measurement the 2026-09-20..2026-09-24 runs used:
...
MARK = "2026-09-24T03:57:50.000Z"          # newest lastmod of the 2026-09-24 pull
...
ai_strict = [x for x in ai if SPEND.search(x[0])]
...
(D / "_window_0925.json").write_text(json.dumps(out, indent=1))
