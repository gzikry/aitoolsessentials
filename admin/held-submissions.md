...
| Short.now | short.now | 2026-09-14 | gem88612@gmail.com (cc mail@short.now) | **Request sent 2026-09-14** (Sent msg 168). Awaiting reply — no legal entity, registered address, or jurisdiction named (ToS §13 refers to "the jurisdiction in which Short.now is incorporated" without naming it); no subprocessors disclosed; training use and deletion path for uploaded media unstated; free-plan allowance contradicts itself across their own pages ("3 videos to start, then 1 every week" on homepage/FAQ vs "3 free videos every month" on /tools/*, /compare/*, /for/*); Starter price contradicts itself ($7/mo card vs "Starter paid plan $12/month (8 videos)" on the Opus Clip comparison); competitor free-tier row inaccurate (Opus Clip publishes $0/60 credits per month); submitter authorisation unconfirmed (form address is a personal Gmail) |
